...
<head>
    ...
    <title>Login | Online Shop Arum Pikachu</title>
    <!-- Favicon-->
    ...
    <!-- Bootstrap Core Css -->
    <link href="<?=base_url()?>assets/plugins/plugins/bootstrap/css/bootstrap.css" rel="stylesheet">
	...
	<div class="card1">
		<div class="ok">
            <div class="row">
                <div class="col-md-12">
                    <div class="logo">
                        <a href="<?=base_url()?>javascript:void(0);">ONLINE<span>SHOP</span></a>
                    </div>
                </div>
            </div>
		</div>
